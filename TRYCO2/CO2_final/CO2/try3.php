        ...
        <div id="edit-section" class="form-section" style="display: none;">
            ...
            <form id="edit-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="edit-detailed-address" value="東平路70號1樓">
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-success">修改地址</button>
                <button type="button" class="btn btn-danger">刪除地址</button>
            </form>
        </div>
    </div>
