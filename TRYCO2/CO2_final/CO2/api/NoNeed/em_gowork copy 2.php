        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                form.addEventListener("submit", function(event) {
                    ...
                    const addressSelect = document.getElementById("gowork_address");
                    const selectedOption = addressSelect.options[addressSelect.selectedIndex].text;
                    const transportMode = form.elements["gowork_car"].value;
            ...
            function geocode(address, transportMode, form) {
                ...
                geocoder.geocode(geocodingParameters, (result) => {
                    ...
                    if (locations.length > 0) {
                        ...
                        calculateRoute(location, transportMode, form);
                    } else {
                        alert('未找到地址，請輸入正確地址');
                    }
                }, (error) => {
            ...
            function calculateRoute(location, transportMode, form) {
            ...
            function addSummaryToPanel(route, form) {
                let distance = 0,
                    duration = 0;
                ...
                // const summary = route.sections[0].travelSummary;
                // const distance = (summary.length / 1000).toFixed(2);
