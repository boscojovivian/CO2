...
// // 使用自定義圖標創建標記
// var company = new H.map.Marker({ lat: 24.149878365016026, lng: 120.68366751085637 }, { icon: icon });
// group.addObject(company);    //將標記添加到群組
    ...
    function onSuccess(result) {
        ...
        var router = platform.getRoutingService(null, 8),
            routeRequestParams = {
                ...
                origin: company.getGeometry().lat + ',' + company.getGeometry().lng, // 終點
                destination: origin,         // 起點
