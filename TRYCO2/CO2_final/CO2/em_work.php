                                ...
                                <div id="文字靠左">
                                    ...
                                    <div class="work_city_div" style="background-color: #8cb4bf;">
                                        ...
                                        <div id="水平靠左">
                                            ...
                                            &nbsp
                                            <input class='work_address_detail' style="background-color:#e2ebf7; color:#527c7c; border:2px solid #9bc9ca;" type="text" id="address_detail_0" name="address_detail[]" value="三民路三段129號" required>
                                        </div>
                                    </div>
